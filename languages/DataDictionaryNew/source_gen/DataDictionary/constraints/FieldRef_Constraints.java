...
public class FieldRef_Constraints extends BaseConstraintsDescriptor {
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              ...
              SNode structureAsAField = (SNode) _context.getEnclosingNode();
              SNode node_struct = SLinkOperations.getTarget(structureAsAField, MetaAdapterFactory.getReferenceLink(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af79708bL, 0x62cd8899af797090L, "strucutreRef"));
              List<SNode> possibleFields = ListSequence.fromList(new LinkedList<SNode>());
              for (SNode field : ListSequence.fromList(SLinkOperations.getChildren(node_struct, MetaAdapterFactory.getContainmentLink(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x64e4581da5cc8045L, 0x62cd8899af6e8d72L, "fieldList")))) {
                {
                  ...
                  if (SNodeOperations.isInstanceOf(node_field, MetaAdapterFactory.getConcept(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af6dcd98L, "DataDictionary.structure.Field"))) {
                    ListSequence.fromList(possibleFields).addElement(field);
  ...
  private static SNodePointer breakingNode_6i6uxk_a0a0a0a0a1a0b0a1a1 = new SNodePointer("r:c56e0493-2b34-4c5f-bafd-c4e137638e35(DataDictionary.constraints)", "7119496779597775588");
}
